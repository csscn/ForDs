...
def plot_day(var_name,
    ...
    f = nc.Dataset(OUT_PATH+"ERA5LAND_fine_{year:04}_{month:02}_{day:02}_{name}.nc".format(year=year, month=month, day=day_of_month, name=var_name),'r')
...
if __name__ == '__main__':
    ...
    plot_day('t2m', 2018, 1, 30, 'HH', latb=37, latu=39, llon=100, rlon=102)
    plot_day('d2m', 2018, 1, 30, 'HH', latb=37, latu=39, llon=100, rlon=102)
    plot_day('Q', 2018, 1, 30, 'HH', latb=37, latu=39, llon=100, rlon=102)
    plot_day('strd', 2018, 1, 30, 'HH', latb=37, latu=39, llon=100, rlon=102)
    plot_day('sp', 2018, 1, 30, 'HH', latb=37, latu=39, llon=100, rlon=102)
    plot_day('ws', 2018, 1, 30, 'HH', latb=37, latu=39, llon=100, rlon=102)
    plot_day('ssrd', 2018, 1, 30, 'HH', latb=37, latu=39, llon=100, rlon=102)
    plot_day('tp_rf', 2018, 1, 30, 'HH', latb=37, latu=39, llon=100, rlon=102)
